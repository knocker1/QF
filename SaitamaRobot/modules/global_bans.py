...
__help__ = f"""
*Admins only:*
 • `/antispam <on/off/yes/no>`*:* Will toggle our Gban tech or return your current settings.

Gban, used by bot devs to ban spammers across all groups. This helps protect \
