...
__help__ = """ 
\
Sometimes, in a group there are people who make funny comments.
So instead of screenshotting we can make a sticker of the that comment
commands:
- /q : reply to the message of which you want to make sticker and boom there you go!!
\
"""           
